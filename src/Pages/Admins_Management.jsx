...
//           <div className='flex justify-between w-[95%] gap-32 '>
...
// <button className='p-4 font-semibold text-white rounded-xl bg-themeGreen hover:scale-110 hover:transition-all hover:duration-300 hover:cursor-pointer'> 
//   Create Admin
// </button>
...
export default function Admins_Management() {
  ...
  const handleCreateAdmin = async () => {
    try {
      const encryptedPassword = encryptPassword(newAdmin.admin_password);
      const adminToCreate = {
        ...newAdmin,
        admin_password: encryptedPassword
      };
        ...
        <div className="w-full pt-12">
          <div className='flex justify-between w-[95%] gap-32'>
            ...
            <button 
              ...
              className='p-4 font-semibold text-white rounded-xl bg-themeGreen hover:scale-110 hover:transition-all hover:duration-300 hover:cursor-pointer'
            > 
              Create Admin
            </button>
          </div>
          ...
          <div className="flex flex-col w-[95%] gap-10 p-5 pb-12 mt-6 card">
            {/* Search and Table code remains the same */}
            <div className="flex items-center justify-end mb-4">
              <div className="relative">
                <input
                  type="text"
            ...
            {isCreateModalOpen && (
              <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-800 bg-opacity-50">
                <div className="w-full max-w-md p-6 bg-white rounded-lg">
                  <h2 className="text-[20px] leading-[42px] text-themeGreen font-[600] pb-4">Create New Admin</h2>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="relative">
                      ...
                      <button
                        ...
                        className="absolute text-gray-500 transform -translate-y-1/2 right-2 top-1/2"
                      >
                        {showCreatePassword ? <Eye size={20} /> : <EyeOff size={20} />}
                      </button>
                    </div>
                  </div>

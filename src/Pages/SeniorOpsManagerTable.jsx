...
//     const decryptedPassword = decryptPassword(manager.password);
...
//                 <tr>
//                   <th className="px-4 font-[500]">Ops Manager Name</th>
...
//                       <td className="px-4">{manager.email}</td>
//                       <td className="px-4">••••••••</td>
//                       <td className="px-4">{manager.commission}</td>
...
//                       type="number"
//                       name="commission"
//                       value={editedManager.commission || ''}
//                       onChange={handleInputChange}
//                       className="w-full p-2 border border-gray-300 rounded"
//                     />
//                   </div>
...
// export default OpsManagerTable;
        ...
        <div className="w-full pt-12">
          ...
          <div className="flex flex-col w-[95%] gap-10 p-5 pb-12 mt-6 card">
            ...
            <table>
              <thead className="text-themeGreen h-[30px] mb-12">
                <tr>
                  <th className="px-4 font-[500]">Senior Ops Manager Name</th>
                  <th className="px-4 font-[500]">Email</th>
                  <th className="px-4 font-[500]">Password</th>
                  <th className="px-4 font-[500]">Commission</th>
                  <th className="px-4 font-[500]">Secret ID</th>
...
export default SeniorOpsManagerTable;

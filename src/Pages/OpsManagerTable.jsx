...
const OpsManagerTable = () => {
  ...
  const fetchManagers = async () => {
    try {
      ...
      const opsManagers = response.data.filter(manager => manager.manager_role === 'Ops Manager');
                ...
                <div className="w-full max-w-md p-6 bg-white rounded-lg">
                  ...
                  <div className="mb-4">
                    ...
                    <input
                      ...
                      value={editedManager.manager_commision || ''}
                      onChange={handleInputChange}
                      className="w-full p-2 border border-gray-300 rounded"
                      min="0"
                      step="0.01"
...
//     setEditedManager({
//       manager_name: manager.manager_name,
//       manager_commission: manager.manager_commision, // Consistent naming here
//       manager_email: manager.manager_email,
//       manager_secret_id: manager.manager_secret_id,
//       password: decryptedPassword
//     });
...
//                       type="number"
//                       name="commission"
//                       value={editedManager.manager_commission || ''}
//                       onChange={handleInputChange}
//                       className="w-full p-2 border border-gray-300 rounded"
//                       min="0"  step="any"
//                     />
